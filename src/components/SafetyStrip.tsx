...
export function SafetyStrip({ notice }: { notice: SafetyNotice }) {
  return (
    <aside
      className="flex gap-3 rounded-[1.5rem] border border-amber-500/30 bg-amber-500/10 px-4 py-4 text-sm leading-relaxed text-amber-950 shadow-sm backdrop-blur-sm dark:text-amber-100"
      role="note"
    >
