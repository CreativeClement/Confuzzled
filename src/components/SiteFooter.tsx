...
export function SiteFooter() {
  return (
    <footer className="relative mt-8 overflow-hidden border-t border-border/60 print:hidden">
      <div aria-hidden="true" className="hairline top-0 via-violet-400/70" />
        ...
        <nav aria-label="Footer" className="flex flex-wrap items-center justify-center gap-2">
          {LINKS.map((link) => (
            <Button
              ...
              variant="outline"
              size="sm"
              className="rounded-full border-border/90 bg-background/80"
            >
