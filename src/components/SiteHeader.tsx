...
export function SiteHeader() {
  ...
  return (
    <header className="header-float sticky top-0 z-40 print:hidden">
      <div className="container pb-2 pt-[max(0.65rem,env(safe-area-inset-top))]">
        <div className="relative flex min-h-16 items-center justify-between gap-3 rounded-[1.75rem] border border-border/50 bg-background/65 px-3 py-2 shadow-[0_18px_50px_-28px_hsl(266_90%_55%/0.55)] backdrop-blur-xl sm:px-4">
