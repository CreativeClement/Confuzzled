...
export function SiteHeader() {
  ...
  return (
    <header className="sticky top-0 z-40 print:hidden">
      <div className="container pt-[max(0.75rem,env(safe-area-inset-top))] pb-2">
        <div className="header-float flex min-h-14 items-center justify-between gap-3 px-3 py-2 sm:px-4">
          <div aria-hidden="true" className="hairline bottom-0 inset-x-5" />
