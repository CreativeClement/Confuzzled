  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-2xl text-sm font-semibold transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        brand:
          "btn-shine relative overflow-hidden border-0 bg-[length:220%_220%] bg-gradient-to-r from-violet-600 via-indigo-500 to-cyan-500 text-white shadow-[0_16px_40px_-16px_rgba(139,92,246,0.8)] animate-shimmer transition-[filter,transform] hover:brightness-110 hover:scale-[1.02] active:scale-[0.98]",
