            ...
            {NAV.map((item) => {
              ...
              return (
                <Link
                  ...
                  href={item.href}
                  className={cn(
                    "inline-flex min-h-12 shrink-0 items-center gap-2 rounded-xl px-4 text-sm font-medium transition-all duration-200",
                    active
                      ? "bg-gradient-to-r from-violet-600 to-cyan-600 text-white shadow-glow"
