  ...
  return (
    <div className="container flex flex-1 flex-col gap-6 py-8 lg:flex-row">
      <aside className="lg:w-60 print:hidden">
        <div className="surface-card-static mb-4 p-4">
            ...
            return (
              <Link
                ...
                className={cn(
                  ...
                  active
                    ? "bg-gradient-to-r from-violet-600 to-cyan-600 text-white shadow-[0_12px_28px_-16px_rgba(139,92,246,0.9)]"
                    : "border border-border/70 bg-background/50 text-secondary-foreground hover:bg-secondary/80",
                )}
