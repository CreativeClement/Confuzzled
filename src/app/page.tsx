  ...
  return (
    <main id="main" className="pb-8">
      <section
        ...
        className="container flex flex-col items-center pt-8 text-center sm:pt-14"
      >
        <LogoHalo>
        ...
        <Link
          href="/honesty"
          className="mt-4 inline-flex items-center rounded-full border border-primary/30 bg-primary/10 px-3 py-1 text-xs font-medium text-foreground transition-colors hover:border-primary/50"
        >
