  ...
  return (
    <main id="main" className="pb-8">
      ...
      >
        ...
        <p className="kicker mt-6 tracking-[0.28em]">Confuzzle</p>
        <h1
          id="hero-heading"
        ...
        <Link
          href="/honesty"
          className="mt-4 inline-flex items-center gap-2 rounded-full border border-primary/30 bg-primary/10 px-3 py-1 text-xs font-medium text-foreground hover:border-primary/50"
        >
