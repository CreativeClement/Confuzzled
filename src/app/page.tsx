  ...
  return (
    <main id="main" className="pb-8">
      ...
      >
        ...
        >
          {PROOF.map((item) => (
            ...
            >
              <span
                aria-hidden="true"
                className="h-1.5 w-1.5 rounded-full bg-gradient-to-r from-violet-500 to-cyan-400"
              />
              {item}
            </li>
          ))}
        ...
        <Link
          href="/honesty"
          className="fade-up fade-up-delay-4 mt-4 inline-flex items-center rounded-full border border-primary/30 bg-primary/10 px-3 py-1 text-xs font-medium text-foreground shadow-[0_0_24px_-8px_hsl(266_90%_55%/0.6)] hover:border-primary/50"
        >
